export const GlobalResult = () => {
  const globalDatabase = [
    {
      value: "1,100+",
      description: "Clients Reduced 20-25% of their Body Weight",
    },
    {
      value: "7,600+",
      description: "GLP-I Injections & Weight Loss Supplements Delivered",
    },
    {
      value: "3,400+",
      description: "Successful Teleconsultations with Specialist Physician",
    },
